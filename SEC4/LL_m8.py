...
#revierte el orden de las fechas 
    def reverse(self):
        #invertimos el inicio con el final 
        temp = self.head 
        self.head = self.tail #el final al inicio 
        self.tail = temp #el inicio al final 
        ...
        for _ in range(self.length):
             after = temp.next 
             temp.next = before #se voltea el apuntador en la dir contraria y se separa la lista 
             before = temp
             temp = after

LISTA_UNIDA = LinkedList(1)
LISTA_UNIDA.append(2)
LISTA_UNIDA.append(3)
LISTA_UNIDA.append(4)

LISTA_UNIDA.print_ll()
print("\t")
